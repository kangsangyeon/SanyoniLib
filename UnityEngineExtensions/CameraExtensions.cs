...
namespace SanyoniLib.UnityEngineExtensions
{
    public static class CameraExtensions
    {
        ...
        public static bool IsVisible2D(this UnityEngine.Camera me, Vector3 worldPosition, bool simpleCheck = true)
        {
            if (simpleCheck == true)
            {
                Vector3 screenPoint = me.WorldToViewportPoint(worldPosition);
